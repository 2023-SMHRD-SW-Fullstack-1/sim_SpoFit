...
const LeportsPlaceForm3_1 = () => {
  ...
  return (
    ...
    <div className='searchResult'>
      {isDesktop && <strong className='leportsNameTitle1'>어려명이서 즐길 수 있는 대표적인 실내 레포츠</strong>}
    ...
    <Container>
      ...
      <div>
        ...
        <Row  id='img-container'>
          ...
          <Col><img width='120px'src='https://cdn-icons-png.flaticon.com/512/4363/4363824.png'/>
          ...
          <Col><img width='120px'src='https://cdn-icons-png.flaticon.com/512/3784/3784383.png'/>
          <span className='leportsName'> 배드민턴 </span>
          </Col>
        </Row>
        <Row  id='img-container1'>
          <Col><img width='120px'src='https://cdn-icons-png.flaticon.com/512/4498/4498657.png'/>
          <span className='leportsName'>태권도</span>
          </Col>
          <Col><img width='120px'src='https://cdn-icons-png.flaticon.com/512/2514/2514078.png'/>
          <span className='leportsName'>실내 골프</span>
          </Col>
          <Col><img width='120px'src='https://cdn-icons-png.flaticon.com/512/8969/8969972.png'/>
          <span className='leportsName'>당구</span>
          </Col>
...
export default LeportsPlaceForm3_1