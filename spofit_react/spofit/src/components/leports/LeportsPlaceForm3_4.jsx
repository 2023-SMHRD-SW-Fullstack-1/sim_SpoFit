...
const LeportsPlaceForm3_4 = () => {
  ...
  return (
    ...
    <div className='searchResult'>
      {isDesktop && <strong className='leportsNameTitle1'>혼자 또는 둘이서 즐길 수 있는 대표적인 실외 레포츠</strong>}
    ...
    <Container>
      ...
      <div>
        ...
        <Row  id='img-container'>
          <Col><img width='120px'src='https://cdn-icons-png.flaticon.com/512/5850/5850747.png'/>
          <span className='leportsName'>낚시</span>
          </Col>
          <Col><img width='120px'src='https://cdn-icons-png.flaticon.com/512/3114/3114112.png'/>
          <span className='leportsName'>자전거</span>
          </Col>
          <Col><img width='120px'src='https://cdn-icons-png.flaticon.com/512/2038/2038265.png'/>
          <span className='leportsName'> 승마</span>
          </Col>
          <Col><img width='120px'src='https://cdn-icons-png.flaticon.com/512/808/808433.png'/>
          <span className='leportsName'> 런닝</span>
          </Col>
        </Row>
        <Row  id='img-container1'>
          <Col><img width='120px'src='https://cdn-icons-png.flaticon.com/512/5987/5987715.png'/>
          <span className='leportsName'>등산</span>
          </Col>
          <Col><img width='120px'src='https://cdn-icons-png.flaticon.com/512/2503/2503387.png'/>
          <span className='leportsName'>번지점프</span>
          </Col>
          <Col><img width='120px'src='https://cdn-icons-png.flaticon.com/512/6531/6531586.png'/>
          <span className='leportsName'>보드</span>
          </Col>
          <Col><img width='120px'src='https://cdn-icons-png.flaticon.com/512/1403/1403737.png'/>
          <span className='leportsName'>양궁</span>
          </Col>
        </Row>
...
export default LeportsPlaceForm3_4